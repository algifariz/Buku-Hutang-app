            ...
            <div class="card-body">
              <div class="row">
                <div class="col text-center">
                  ...
                  <div class="text-muted text-small"><span class="text-primary"><i class="fas fa-caret-up"></i></span>
                    48%</div>
                </div>
                <div class="col text-center">
                ...
                <div class="col text-center">
                  ...
                  <div class="text-muted text-small"><span class="text-danger"><i class="fas fa-caret-down"></i></span>
                    14%</div>
                </div>
                <div class="col text-center">
